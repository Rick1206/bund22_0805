...
<div class="about wrap mdcont fn-clear">
    ...
    <div class="fn-left">
        <div class="sublist">
            <a href="photo_gallery.php" <?php echo ($type_id==0) ? "class='on'" :""; ?>>全 部</a>
            <a href="photo_gallery.php?type_id=1" <?php echo ($type_id==1) ? "class='on'" :""; ?>>简 介</a>
            <a href="photo_gallery.php?type_id=2" <?php echo ($type_id==2) ? "class='on'" :""; ?>>品 牌</a>
            <a href="photo_gallery.php?type_id=3" <?php echo ($type_id==3) ? "class='on'" :""; ?>>活 力</a>
            <a href="photo_gallery.php?type_id=4" <?php echo ($type_id==4) ? "class='on'" :""; ?>>场 地</a>
            <a href="photo_gallery.php?type_id=5" <?php echo ($type_id==5) ? "class='on'" :""; ?>>婚 礼</a>
        </div>
    </div>
