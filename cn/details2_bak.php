...
<body>
    <div id="lightdetail" class="pop-detail">
        ...
        <ul id="img_plus">
			...
			?>
            <li><img src="<?php echo $file_dir."/enticement_photo/".$phoThisB['photo']; ?>" alt="" width="750" height="500"></li>
            <?php
				}
			?>
        ...
        <div class="txtbox fn-clear">
            <div class="fn-left left">
                <p><span class="h">网站: </span><span class="r"><?php echo $infoB['website']; ?></span></p>
                <div class="hdlw"></div>
                <ul class="dwlist">
					<?php 
