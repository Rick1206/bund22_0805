			...
			<div class="head fn-clear">
				...
				<div class="fn-left">
					<div class="logo fn-left">
						...
						<![endif]--> <img src="images/logo.png" alt="My Bund 22"> </a>
					</div>
					<div class="menu_b fn-clear">
						<ul>
							<li>
								<a href="./" class="tar nav1"><i class="home" data-def="首 页"></i></a>
							</li>
							<li>
							...
							<li>
								<a href="wedding.php" class="tar nav6 <?php echo ($pnum =="6") ? "sel": "" ?>"><i class="wedding" data-def="婚 宴"></i></a>
							</li>
							<li>
			...
			<div class="sub" data-tg="about" style="display: <?php echo ($pnum =="2") ? "block": "none" ?>">
				<div class="wrap">
					<div style="margin-left: 175px;background-color: #000;padding-bottom: 5px;" class="fn-left">
						<a href="about.php" class="<?php echo ($psnum =="1") ? "sel": "" ?>"><i class="history"></i>关于我们</a>
						<a href="history2.php" class="<?php echo ($psnum =="2") ? "sel": "" ?>"><i class="history"></i>历 史</a>
						<a href="directions.php" class="<?php echo ($psnum =="3") ? "sel": "" ?>"><i class="directions"></i>地 图</a>
					</div>
				</div>
			</div>
			...
			<div class="sub" data-tg="gallery" style="display: <?php echo ($pnum =="7") ? "block": "none" ?>">
				<div class="wrap">
					<div style="margin-left: 567px;background-color: #000;padding-bottom: 5px;" class="fn-left">
						<a href="photo_gallery.php" class="<?php echo ($psnum =="9") ? "sel": "" ?>"><i class="photo"></i>照 片</a>
