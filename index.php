...
<div class="wrap100">
    ...
    <div class="lastest fn-clear">
        ...
        <ul>
        	<?php
        	$EnticementInfo = get_Enticement_Info("en","1");
            ...
            <li>
                ...
                <a class="m moredetails" href="details2.php?id=<?php echo $subB['enticement_id']; ?>">Read more</a>
            </li>
            <?php
				}
			?>
